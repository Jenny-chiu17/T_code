  ...
  <div class="grid lg:grid-cols-2 gap-6">
    ...
    <div class="card p-8">
      ...
      <div v-else class="space-y-4">
        ...
        <!-- 文件列表預覽 -->
        <div v-if="policyStatus.files && policyStatus.files.length > 0" class="mt-6">
          <p class="text-sm font-medium text-gray-700 mb-2">文件列表 (部分):</p>
          <div class="space-y-1 max-h-32 overflow-y-auto">
            <div 
              v-for="file in policyStatus.files.slice(0, 5)" 
              :key="file"
          ...
          <p v-if="policyStatus.fileCount > 5" class="text-xs text-gray-500 mt-2">
